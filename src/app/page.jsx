    ...
    <>
      ...
      <section className="lg:p-20 p-4">
        <div className="lg:flex justify-between">
          ...
          <div className="lg:w-[60%]">
            <p className="text-xl">At Doklus Green, we maximize value and drive
        ...
        <div id="commitment" className="text-center bg-[#009C3E] text-white lg:p-20 p-6 mt-20 text-center">
          ...
          <div className="lg:w-1/2 mx-auto mt-4">
            <p className="text-xl">We strive to reduce our environmental impact
      ...
      <section className="lg:p-20 p-4">
        <div className="lg:w-[30%]">
          ...
          <p className="text-xl mb-4">We offer a wide range of services that
      ...
      <section className="lg:p-20 p-4 text-[#001008] lg:flex">
        <div className="mr-4 bg-[#AFE67F] p-10 w-full">
          ...
          <p className="text-xl mt-6">We are committed to integrating sustainability into our operations, prioritizing environment, health and safety while upholding transparency and accountability at all levels.</p>
          <button className="flex mt-20">
      ...
      <section className="lg:px-20 px-4 pb-20">
        <div className="lg:w-[30%] text-center mx-auto">
          ...
          <p className="text-xl">Our clients are top players both in the public and
            private sectors.</p>
        </div>
